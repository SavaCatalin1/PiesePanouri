...
export default function Rezultate({ tipMontaj, rezultat, details }) {
    ...
    return (
        <div className='rezultate-body'>
            <div className='rezultate-row'>{tipMontaj === 1 && <span><b>Cleme mici: </b> {rezultat[0]} buc</span>}{tipMontaj === 0 && <span><b>Cleme interioare:</b> {rezultat[0]} buc {detailsToggle ? details : ""}</span>}{tipMontaj === 2 && <span><b>Cleme interioare:</b> {rezultat[0]} buc</span>}</div>
